...
const Input = ({type, label, style, disabled, className, secondaryComponent, containerStyle, name, placeholder, value, onChange, onBlur, onFocus, notification, required, ariaLabel, ...props}) => {
